...
/*
   ...
   + 3.6 2015-08-20 	Tested on 4.3. Added ALT attribute to gallery images, plus special chars in ALT and TITLE are now correctly escaped
...
function sga_gallery_render( $atts, $content = null ) {
	...
	*/
	...
	if ($atts['type'] && is_array($sga_gallery_params[$atts['type']])) {
